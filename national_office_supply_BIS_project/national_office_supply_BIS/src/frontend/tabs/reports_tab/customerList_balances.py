...
class CustomerListReportView(ctk.CTkFrame):
    ...
    def _build_header(self):
        ...
        ctk.CTkLabel(
            title_row, text="Customer List & Balances",
        ...
        ctk.CTkButton(
            right, text="⬇  Export CSV", width=130, height=34,
            corner_radius=6, fg_color=BRAND_NAVY, hover_color="#002a7a",
    ...
    def _build_filter_bar(self):
        ...
        ctk.CTkLabel(inner, text="With Balance Only:", font=FONT_BODY, text_color=TEXT_MUTED).pack(side="left")
        self._balance_var = ctk.BooleanVar(value=False)
        ctk.CTkCheckBox(
            inner, text="", variable=self._balance_var, width=30,
            fg_color=ACCENT_AMBER, hover_color="#e67e22",
            command=self._apply_filter,
        ).pack(side="left", padx=(4, 0))

        self._count_label = ctk.CTkLabel(
            inner, text=f"{len(self.customers)} records",
            font=FONT_SMALL, text_color=TEXT_MUTED,
        )
    ...
    def _build_tabs(self):
        ...
        tab_bar = ctk.CTkFrame(
            ...
            corner_radius=10, border_width=1, border_color=BORDER, height=48,
        )
    ...
    def _build_customers_tab(self, parent) -> ctk.CTkFrame:
        ...
        self._customers_tree.tag_configure("new",      foreground=BRAND_BLUE, font=("Segoe UI", 11, "bold"))
    ...
    def _build_balances_tab(self, parent) -> ctk.CTkFrame:
        ...
        cols   = ("Cust. No.", "Company",  "Invoice No.", "Invoice Date", "Amount Due", "Paid?",    "Shipped?")
        ...
        self._balances_tree.tag_configure("unpaid",  foreground=ACCENT_RED,  font=("Segoe UI", 11, "bold"))
    ...
    def _populate_balances(self):
        ...
        for inv in self.invoices:
            ...
            if isinstance(inv_date, str):
                try:
                    inv_date_str = datetime.date.fromisoformat(inv_date).strftime("%Y-%m-%d")
                except ValueError:
