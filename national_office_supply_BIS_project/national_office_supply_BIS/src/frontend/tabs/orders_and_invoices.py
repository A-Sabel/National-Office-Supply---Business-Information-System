...
class ManageInvoicesPanel(ctk.CTkFrame):
    ...
    def _apply_filter(self, _=None):
        ...
        self.filtered = [
            ...
            and (
                q in inv["invoice_number"].lower() or q in inv["customer_name"].lower()
            )
        ]
        self._render_rows()
...
class OrdersView(ctk.CTkFrame):
    ...
    def _load_data(self):
        if HAS_DB and self.db_config and psycopg2 is not None:
            try:
